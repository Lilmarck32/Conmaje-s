...
<html>
	<head>
		...
		<meta name="keywords" content="alta, registros, formulario, conmajes, actualizaciones" />
	...
	<body style="background-image: url('imagenes/imagen12.jpg'); background-repeat: no-repeat; background-size: 100; background-attachment: fixed;">
		<div id="cont">
			...
			<?php
				...
				mysql_query("insert into registros(nombres,apellidos,numero,edad,genero,videojuego,consolas,comentarios)values('$_REQUEST[nombres]','$_REQUEST[apellidos]','$_REQUEST[numero]','$_REQUEST[edad]','$_REQUEST[genero]','$_REQUEST[videojuego]','$_REQUEST[consolas]','$_REQUEST[comentarios]')",$conexion)
				or die("Algo raro paso tienes problemas con los campos".mysql_error());
				mysql_close($conexion);
				echo "<center><mans>El registro fue todo un exito, gracias por tu participaci&oacute;n descubre las actualizaciones proximamente</center></mans>";
			?>
			<br>
			<br>
			<center><img src="imagenes/imagen69.gif" class="enl" /></center>
			<br>
			<br>
