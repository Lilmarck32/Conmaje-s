...
<html>
	<head>
		<title>Eliminar Conmaje's</title>
		...
		<meta name="keywords" content="baja, registros, formulario, conmajes, eliminar" />
	...
	<body style="background-image: url('imagenes/imagen12.jpg'); background-repeat: no-repeat; background-size: 100; background-attachment: fixed;">
		<div id="cont">
			...
			<?php
					...
					mysqli_query($conexion,"delete from registros where nombres=('$_REQUEST[nombres]')")
					or die (mysql_error($conexion));
					mysqli_close($conexion);
					echo "<center><mans>El registro de la persona llamada $_REQUEST[nombres] ha sido eliminado</mans><center>";
			?>
			<br>
			<br>
			<center><img src="imagenes/imagen70.gif" class="enl" /></center>
			<br>
			<br>
